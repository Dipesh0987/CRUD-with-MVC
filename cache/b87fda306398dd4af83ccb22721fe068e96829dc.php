...
<form method="post" action="index.php?action=update">
    ...
    <input name="name" value="<?php echo e($employee['name']); ?>" required><br><br>
    <input name="title" value="<?php echo e($employee['title']); ?>" required><br><br>
    <input name="skills" value="<?php echo e($employee['skills']); ?>" required><br><br>
